...
export default class AddNewElementFCS extends Component<Props> {
  render() {
    return (
      <div>
        <h4 id="add-new-user">Add New Element for the countries or states</h4>
          ...
          <table className="smfp-form-table">
            <tbody>
              ...
              <tr className="form-field">
                ...
                <td>
                  <select className="smfp-select2" name="Year_el" id="Year_el">
              ...
              <tr className="form-field">
                ...
                <td>
                  <input name="extraction_el" type="text" id="extraction_el" />
                </td>
              </tr>
              <tr className="form-field">
                <th scope="row">
                ...
                <td>
                  <input name="Production_el" type="text" id="Production_el" />
                </td>
              </tr>
              <tr className="form-field">
                <th scope="row">
