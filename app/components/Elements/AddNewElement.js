                  ...
                  <form>
                    <table className="smfp-form-table">
                      <tbody>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Atomic_number_element">
                              Atomic number
                            </div>
                          </th>
                          <td>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Atomic_Volume_element">
                              Atomic Volume
                            </div>
                          </th>
                          <td>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Melting_point_element">
                              Melting point
                            </div>
                          </th>
                          <td>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Boiling_point_element">
                              Boiling point
                            </div>
                          </th>
                          <td>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Phase_at_STP_element">
                              Phase at STP
                            </div>
                          </th>
                          <td>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Special_weight_element">
                              Special weight
                            </div>
                          </th>
                          <td>
                        ...
                        <tr className="form-field">
                          <th scope="row">
                            <div className="Atomic_radius_element">
                              Atomic radius
                            </div>
                          </th>
                          <td>
